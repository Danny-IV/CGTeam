...
let cameraCircleHeight = 0.0; // 바뀌는 변수 let으로 선언
const cameraCircleSpeed = 90.0; 
const sp = new squarePyramid(gl);
...
function render() {
    ...
    cameraCircleHeight = 5+5 * Math.sin(glMatrix.toRadian(cameraCircleSpeed * elapsedTime)/2); // 카메라 y축으로 높이 조절 반복
